...
class Opm extends SB_Controller 
{
	...
	function __construct() {
		...
		$this->load->model('opmmodel');
		$this->model = $this->opmmodel;
	...
	function index() 
	{
		...
		$this->data['content'] = $this->load->view('opm/index',$this->data, true );
	...
	function show( $id = null) 
	{
		...
		if($row)
		{
			...
			$this->data['row'] = $this->model->getColumnTable('tb_bigbluebutton'); 
		}
		
		$this->data['id'] = $id;
		$this->data['content'] =  $this->load->view('opm/view', $this->data ,true);	  
		$this->load->view('layouts/main',$this->data);
	}
	...
	function add( $id = null ) 
	{
		...
		$this->data['id'] = $id;
		$this->data['content'] = $this->load->view('opm/form',$this->data, true );		
	  	$this->load->view('layouts/main', $this->data );
