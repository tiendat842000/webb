...
class Registeronline extends SB_Controller 
{

	protected $layout 	= "layouts/main";
	public $module 		= 'registeronline';
	public $per_page	= '10';

	function __construct() {
		parent::__construct();
		
		$this->load->model('registeronlinemodel');
		$this->model = $this->registeronlinemodel;
...
//		}	
		...
		$this->data['content'] = $this->load->view('registeronline/index',$this->data, true );
	...
	function show( $id = null) 
	{
		...
		if($row)
		{
			...
			$this->data['row'] = $this->model->getColumnTable('tb_register'); 
		}
		
		$this->data['id'] = $id;
		$this->data['content'] =  $this->load->view('registeronline/view', $this->data ,true);	  
		$this->load->view('layouts/main',$this->data);
	}
...
//			if($this->access['is_edit'] ==0) redirect('dashboard',301);	
		...
		$this->data['id'] = $id;
		$this->data['content'] = $this->load->view('registeronline/form',$this->data, true );		
	...
	function save() {
		...
		if( $this->form_validation->run() )
		{
			...
			// Redirect after save	
                        $this->session->set_flashdata("success","Data has been saved succesfuly !");
                        redirect('registeronline/add',301);
